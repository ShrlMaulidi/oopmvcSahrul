...
if ($uri[1] === 'edit' && isset($_GET['id'])) {
    $judul = "Edit Anggota";
    $form_action = "http://localhost:8012/oopmvc/index.php/anggota/edit?id=" . $_GET['id'];
} else {
    $judul = "Tambah Anggota";
    $form_action = "http://localhost:8012/oopmvc/index.php/anggota/create";
}
...
<div class="container">
    ...
    <h1><?= $judul ?></h1>  
     <a class="btn btn-success" href="http://localhost:8012/oopmvc/index.php/anggota"> KEMBALI </a>
